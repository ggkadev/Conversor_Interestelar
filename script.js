var nomeUsuario = "Gika";
var valorEmAnosLuz = 500;
...
alert('Olá ' + nomeUsuario + '! ' + valorEmAnosLuz + ' anos-luz correspondem a '+ valorEmMetros +' metros, o que corresponde a ' + valorEmKm + ' Km');
